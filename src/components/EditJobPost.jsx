  ...
  return (
    <div className="editPost">
      ...
      <form className="col" onSubmit={handleSubmit}>
        ...
        <textarea id='description'type="text" placeholder="Enter the Job description" cols="30" rows="10" value={formValues.description} onChange={handleChange}></textarea>

        <label htmlFor="requirements">Requirements: </label>
        <textarea id='requirements'type="text" placeholder="Enter the Job requirements" cols="30" rows="10" value={formValues.requirements} onChange={handleChange}></textarea>
        ...
        <button className="button" type="submit" disabled={!formValues.title || !formValues.description || !formValues.requirements || !formValues.location || !formValues.salary || !formValues.application_url}>Submit Change</button>
